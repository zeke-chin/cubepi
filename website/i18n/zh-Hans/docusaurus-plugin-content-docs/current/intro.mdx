...
人机协同（[指南 →](./guides/hitl/overview)）—— `HitlChannel`、
`CheckpointedChannel`、`ask_user`、`ConfirmToolCallMiddleware` ——
已在 0.6 发布。原生 OpenTelemetry 追踪模块（[指南 →](./guides/tracing/overview)）——
